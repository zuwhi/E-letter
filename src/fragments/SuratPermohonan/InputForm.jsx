    ...
    <>
      <Accordion icon={faEnvelope} label="Kop Surat">
        <div className="my-2 grid grid-cols-2 grid-rows-4 w-full justify-around gap-2">
          ...
          {/* not yet */}
          <Select label="Periode Pengurus" name="periode" value={surat.periode || ""} handleChange={handleChange} className="select select-bordered w-full bg-blue-50 mt-2" options={generateYearOptions()} />
      ...
      <Accordion icon={faCalendarDay} label="Informasi Acara">
        ...
        <div className="my-2 grid grid-cols-2 w-full justify-around gap-2">
          ...
          <Input error={error.tanggalSelesai}  label="Selesai Tanggal" type="date" placeholder="masukkan tanggal" name="tanggalSelesai" value={surat.tanggalSelesai || ""} handleChange={handleChange}></Input>
        </div>
      ...
      <Accordion icon={faPenNib} label="Pengesahan">
        <div className="my-2 mb-10 grid grid-cols-2 grid-rows-3 w-full justify-around gap-2">
          ...
          <Input type="number" label="NIM Ketua Organisasi" placeholder="masukkan NIM ketua organisasi" name="nim_ketua_organisasi" value={surat.nim_ketua_organisasi || ""} handleChange={handleChange}></Input>
        </div>
      </Accordion>
    </>
  );
