    ...
    <>
      <div className="">
        <div className="w-full flex leading-[1.0] justify-around ">
          <div className="relative w-[19%] h-[6rem] items-center  flex  mt-2 pl-4 px-3">{surat.logo_instansi && <img src={surat.logo_instansi} alt="" className="w-fit" />}</div>
          ...
          <table className="w-[70%]">
            <tbody>
              <tr>
                ...
                <td>:</td>
                <td>
                  <EditInput name="nama_mahasiswa" variant="" value={surat.nama_mahasiswa || ""} handleChange={handleChange} />
                </td>
              </tr>
              <tr>
                <td>NIM</td>
                <td>:</td>
                <td>
                  <EditInput name="nim_mahasiswa" variant="" value={surat.nim_mahasiswa || ""} handleChange={handleChange} />
                </td>
              </tr>
            </tbody>
          </table>
